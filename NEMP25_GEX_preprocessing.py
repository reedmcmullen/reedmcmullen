...
results_file_initial = directory_path + '/NEMP25_initial.h5ad'
...
results_file_counts = directory_path + '/NEMP25_counts.h5ad' # the file that will store the analysis results
